  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      <header class="comm-title">
        <h2 class="fl tac">
          <span class="c-333">All Course</span>
        </h2>
      </header>
      <section class="c-sort-box">
          ...
          <section class="fl">
            <ol class="js-tap clearfix">
             <li :class="{'current bg-orange':buyCountSort!=''}">
                <a title="销量" href="javascript:void(0);" @click="searchBuyCount()">Number
                <span :class="{hide:buyCountSort==''}">↓</span>
                </a>
              </li>
              <li :class="{'current bg-orange':gmtCreateSort!=''}">
                <a title="最新" href="javascript:void(0);" @click="searchGmtCreate()">New
        ...
        <div class="mt40">
          ...
          <section class="no-data-wrap" v-if="data.total==0">
            ...
            <span class="c-666 fsize14 ml10 vam">Don't has relavant class...</span>
          </section>
          <!-- /无数据提示 结束-->
              ...
              <li v-for="item in data.items" :key="item.id">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    ...
                    <div class="cc-mask">
                      <a :href="'/course/'+item.id" title="go start" class="comm-btn c-btn-1">Start</a>
                    </div>
                  </section>
                  ...
                  <section class="mt10 hLh20 of">
                    ...
                    <span class="fl jgAttr c-ccc f-fA">
                      <i class="c-999 f-fA">{{item.viewCount}} learned</i>
                      |
