        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-jg">
              ...
              <b class="c-666" style="font-size:24px;">￥{{ courseWebVo.price }}</b>
            </section>
            <section class="c-attr-mt c-attr-undis">
              <span class="c-fff fsize14">Totur： {{ courseWebVo.teacherName }}&nbsp;&nbsp;&nbsp;</span>
            </section>
            <section class="c-attr-mt of">
              <span class="ml10 vam">
                <em class="icon18 scIcon"></em>
                <a class="c-fff vam" title="收藏" href="#">collect</a>
              </span>
            </section>
            <section v-if="isbuy || Number(courseWebVo.price) === 0" class="c-attr-mt">
              <a :href="'/learn/'+this.chapter[0].chapterId" title="立即观看" class="comm-btn c-btn-3">Watch Now</a>
            </section>
        ...
        <aside class="thr-attr-box">
          <ol class="thr-attr-ol">
            <li>
              <p>&nbsp;</p>
              <aside>
                <span class="c-fff f-fM">Buy</span>
                <br>
            ...
            <li>
              <p>&nbsp;</p>
              <aside>
                <span class="c-fff f-fM">Course time</span>
                <br>
            ...
            <li>
              <p>&nbsp;</p>
              <aside>
                <span class="c-fff f-fM">Watch num</span>
                <br>
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li class="lh-menu-second ml30" v-for="video in chapter.children" :key="video.id">
                                <a :href="'/player/' + video.videoSourceId" :title="video.title" target="_blank">
                                  <span class="fr">
                                    <i class="free-icon vam mr10">Free Listen</i>
                                  </span>
                ...
                <div class="mt50 commentHtml">
                  <div>
                    <h6 class="c-c-content c-infor-title" id="i-art-comment">
                      <span class="commentTitle">Course Comments</span>
                    </h6>
                        ...
                        <li class="unBr">
                          ...
                          <div class="of">
                            <section class="n-reply-wrap">
                              <fieldset>
                                <textarea name="" v-model="comment.content" placeholder="COMMENT"
                                  id="commentContent"></textarea>
                              </fieldset>
                              <p class="of mt5 tar pl10 pr10">
                                <span class="fl "><tt class="c-red commentContentmeg" style="display: none;"></tt></span>
                                <input type="button" @click="addComment()" value="Reply" class="lh-reply-btn">
                              </p>
                            </section>
                          </div>
                        </li>
                    ...
                    <div class="paging">
                      ...
                      <a :class="{ undisable: !data.hasNext }" href="#" title="末页"
                        @click.prevent="gotoPage(data.pages)">End</a>
                      <div class="clear" />
                    </div>
                    <!-- 公共分页 结束 -->
                  </div>
  ...
  methods: {
    ...
    initCourseInfo() {
      courseApi.getCourseInfo(this.courseId).then(response => {
        ...
        this.chapter= this.chapterVideoList[0].children
      })
    },
    initComment() {
